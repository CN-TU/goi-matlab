...
function r = al_kmeans(data,k)
% AL_KMEANS performs the MATLAB kmeans algorithm and extracts clustering
% context information
...
% r.cluster.closest: closest cluster of cluster_i
    ...
    [cl,V,A,D] = kmeans(data,k,'start','uniform', 'emptyaction','singleton');
